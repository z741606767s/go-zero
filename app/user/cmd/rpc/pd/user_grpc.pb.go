...
const (
	User_Login_FullMethodName                = "/pd.user/login"
	User_Register_FullMethodName             = "/pd.user/register"
	User_GetUserInfo_FullMethodName          = "/pd.user/getUserInfo"
	User_GetUserAuthByAuthKey_FullMethodName = "/pd.user/getUserAuthByAuthKey"
	User_GetUserAuthByUserId_FullMethodName  = "/pd.user/getUserAuthByUserId"
	User_GenerateToken_FullMethodName        = "/pd.user/generateToken"
)
